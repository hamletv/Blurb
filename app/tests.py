...
class UserModelCase(unittest, TestCase):
    def setUp(self):                    #SQLAlchemy will use in-memory SQLite db during testing
    ...
    def test_follow(self):
        ...
        self.assertEqual(u2.followers.firstz().username, 'john')
    ...
    def test_follow_posts(self):
        ...
        p3 = Post(body='post from mary', author=u2, timestamp=now + timedelta(seconds=3))
